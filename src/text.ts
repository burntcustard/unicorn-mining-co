...
const glyphs = (
  ...
  '2 4 6 1 6 13,' + // 1
  '2 1 9 1 10 4 2 12 11 12,' + // 2
  '2 0 10 3 6 6 10 9 2 12,' + // 3
  '6 1 2 10 10 10M6 7 6 13,' + // 4
  '10 1 3 1 3 7 9 7 8 12 2 12,' + // 5
  '10 1 5 1 2 12 9 12 9 7 3 7,' + // 6
  '2 1 10 1 5 13,' + // 7
...
export interface RenderTextProps {
  ...
  color?: string; // The stroke colour, defaulting to '#fff'.
}
