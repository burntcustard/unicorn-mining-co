---
directors_cut: https://burnt.io/unicorn-mining-co/
# See github.com/js13kGames/hello-world for supported frontmatter
---

Leave the station by pressing any key, fly around, shine the LIGHT into asteroids to search for valuable resources, turn on the DRILL to mine those resources out, open the cargo HATCH to scoop them up, and then dock at one of the many stations to sell items, repair your ship, and buy upgrades like thrusters or a SHIELD.
